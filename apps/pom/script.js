const WORK_TIME = 25 * 60;
    ...
    waveColorPicker.addEventListener("input", (e) => {
      ...
      water.style.background = `radial-gradient(circle at top, ${color}, #2ab6af)`;
      wave1.style.background = hexToRgba(color,0.25);
      wave2.style.background = hexToRgba(color,0.15);
